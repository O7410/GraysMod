package graysblock.graysmod.entity.ai;
        ...
        if (!this.isIdle()) {
            ...
            if (this.targetPos != null) {
                if (!this.targetPos.isWithinDistance(this.entity.getPos(), this.entity.getWidth()) &&
                        (this.entity.getY() <= (double) this.targetPos.getY() || !BlockPos.ofFloored(this.targetPos.getX(), this.entity.getY(), this.targetPos.getZ()).isWithinDistance(this.entity.getPos(), this.entity.getWidth()))) {
