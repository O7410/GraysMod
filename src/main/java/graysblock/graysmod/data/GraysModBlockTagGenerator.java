...
public class GraysModBlockTagGenerator extends FabricTagProvider.BlockTagProvider {

    public GraysModBlockTagGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture) {
