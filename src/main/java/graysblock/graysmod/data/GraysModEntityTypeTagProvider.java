...
public class GraysModEntityTypeTagProvider extends FabricTagProvider.EntityTypeTagProvider {

    public GraysModEntityTypeTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture) {
