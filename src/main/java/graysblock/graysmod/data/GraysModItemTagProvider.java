...
public class GraysModItemTagProvider extends FabricTagProvider.ItemTagProvider {

    public GraysModItemTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture) {
