...
public class GraysModLanguageProvider extends FabricLanguageProvider {

    public GraysModLanguageProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
