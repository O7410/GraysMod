...
public class PrismarineWorkbenchScreen extends HandledScreen<PrismarineWorkbenchScreenHandler> implements RecipeBookProvider {
    ...
    private static final ButtonTextures PRISMARINE_ONLY_FILTER_BUTTON_TEXTURES = new ButtonTextures(
            Identifier.of(GraysMod.MOD_ID, "recipe_book/prismarine_filter_enabled"),
            Identifier.of(GraysMod.MOD_ID, "recipe_book/prismarine_filter_disabled"),
            Identifier.of(GraysMod.MOD_ID, "recipe_book/prismarine_filter_enabled_highlighted"),
            Identifier.of(GraysMod.MOD_ID, "recipe_book/prismarine_filter_disabled_highlighted"));
