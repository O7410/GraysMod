...
public class KilnScreen extends AbstractFurnaceScreen<KilnScreenHandler> {
    private static final Identifier LIT_PROGRESS_TEXTURE = Identifier.of(GraysMod.MOD_ID, "container/kiln/lit_progress");
    private static final Identifier BURN_PROGRESS_TEXTURE = Identifier.of(GraysMod.MOD_ID, "container/kiln/burn_progress");
    private static final Identifier TEXTURE = Identifier.of(GraysMod.MOD_ID, "textures/gui/container/kiln.png");
